...
{
	# change permissions so ${DOCKER_ACCOUNT_NAME} can copy the necessary files
...
{
	# the $CURRENT_SCRIPT_NAME script has finished executing, remove the files in $DOCKER_SOURCE_DIR
