...
# Example Usage:  
# cdd_container_initialize_script "$0" "/usr/src/oracle_deploy/SQL" "SECRET_MAPPING_ARR"
function cdd_container_initialize_script ()
{
	...
	# input validation
	if ! cds_validate_required_vars	"container_sql_directory" "secret_mapping_var_name"; then
	...
	cds_generic_parse_config_data "${secret_mapping_var_name}"
